    ...
    return (
        ...
        >
            <div
                ...
                className="h-full bg-gradient-to-r from-brand-primary via-[#0D9488] to-[#0F766E] transition-all duration-300 ease-out shadow-[0_0_10px_rgba(var(--brand-primary-rgb),0.5)]"
            />
            {/* Glossy overlay */}
            <div
