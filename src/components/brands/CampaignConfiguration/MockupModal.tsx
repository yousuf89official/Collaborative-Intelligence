                ...
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] h-[80vh]">
                    ...
                    <div className="bg-[#0a0a0a] flex flex-col h-full">
                        ...
                        <div className="flex-1 overflow-y-auto p-4 space-y-6">
                            {/* Total Impact Card */}
                            <div className="p-4 rounded-lg bg-gradient-to-br from-[#0D9488]/10 to-[#0D9488]/5 border border-[#0D9488]/20">
                                <p className="text-xs text-[#0D9488]/70 mb-1">Total Views/Impressions</p>
                        ...
                        <div className="p-4 border-t border-[#222]">
                            {postUrl ? (
                                <Button className="w-full bg-white/[0.04] text-white hover:bg-gray-200 gap-2" onClick={() => window.open(postUrl, '_blank')}>
